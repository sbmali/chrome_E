  ...
  var e = {
        ...
        (t.PostMessenger = class {
          constructor({
            ...
            if (
              ...
              (this.useEncryption = (e, t = !1) => {
                const n =
                  r && e !== w.InternalMessageTypes.postMessengerConnect;
            ...
            d(
              this,
              a,
              Object.assign(Object.assign({}, h), w.InternalMessageTypes),
              "f"
            );
          }
          prefix(e) {
          ...
          onReceiveMessage(e) {
            if (e.data && y(this, s, "f")[e.data.type]) {
              if (y(this, c, "f") && !y(this, c, "f").call(this, e.origin))
                return;
          ...
          connect({ targetWindow: e, targetOrigin: t, maxRetries: r = 10 }) {
            return l(this, void 0, void 0, function* () {
              ...
              c &&
                ...
                (y(this, i, "f").requestKey = yield crypto.subtle.generateKey(
                  { length: 256, name: x },
                  !0,
                  ["encrypt", "decrypt"]
                )),
                (s = yield crypto.subtle.exportKey(
                  "jwk",
                  y(this, i, "f").requestKey
                )),
                (y(this, i, "f").iv = o),
                (y(this, i, "f").algorithm = { iv: o, name: x }));
              const u = r || 1;
              let h = null;
              for (let e = 0; e < u; e += 1) {
                try {
                  h = yield y(this, n, "m", f).call(
                    this,
                    w.InternalMessageTypes.postMessengerConnect,
                    {
          ...
          acceptConnections({
            ...
            return (
              ...
              new Promise((e) => {
                const t = y(this, n, "m", p).call(
                  this,
                  {
                    postMessengerConnect: (r, n) =>
          ...
          decrypt(e) {
            return l(this, void 0, void 0, function* () {
              if (!y(this, i, "f").algorithm || !y(this, i, "f").requestKey)
                throw new Error(
                  this.prefix(
          ...
          (h = function (e, t, r = {}, o) {
            return l(this, void 0, void 0, function* () {
              ...
              this.useEncryption(e, !0) &&
                ((i = yield this.encrypt(r)), s && (s = yield this.encrypt(s))),
          ...
          (f = function (e, t = {}, r = {}) {
            return l(this, void 0, void 0, function* () {
              ...
              return (
                ...
                yield y(this, n, "m", h).call(this, e, o, t),
                new Promise((t, n) => {
                  let i = !1;
                  const s = this.addListener(e, (r) =>
                    l(this, void 0, void 0, function* () {
                  ...
                  s = this.addListener(i, (e, r) =>
                    l(this, void 0, void 0, function* () {
                      ...
                      try {
                        ...
                        const t = yield o(s, r);
                        this.logger(
                          `responding to request type '${i}' from target '${this.targetOrigin}':`,
                          t
                        ),
      ...
      1614: (e, t, r) => {
            ...
            (function (e, t) {
              ...
              for (
                ...
                (r = x(r, n, o, i, e[s], 7, -680876936)),
                  ...
                  (r = _(
                    r,
                    (n = x(n, o, i, r, e[s + 15], 22, 1236535329)),
                    o,
                    i,
                    e[s + 1],
                    5,
                  ...
                  (r = E(
                    r,
                    (n = _(n, o, i, r, e[s + 12], 20, -1926607734)),
                    o,
                    i,
                    e[s + 5],
                    4,
                  ...
                  (r = O(
                    r,
                    (n = E(n, o, i, r, e[s + 2], 23, -995338651)),
                    o,
                    i,
                    e[s],
                    6,
              ...
              (function (e) {
                ...
                for (
                  var t = 8 * e.length, r = new Uint32Array(m(t)), n = 0;
                  n < t;
                  n += 8
                )
        ...
        const M = function (e) {
          ...
          for (var f = 0; f < s; ++f) {
            for (var p = new Uint32Array(80), l = 0; l < 16; ++l)
              p[l] = a[f][l];
            for (var d = 16; d < 80; ++d)
              p[d] = C(p[d - 3] ^ p[d - 8] ^ p[d - 14] ^ p[d - 16], 1);
            for (
              var y = r[0], g = r[1], v = r[2], m = r[3], w = r[4], b = 0;
              b < 80;
              ++b
            ) {
    ...
    (() => {
      ...
      !(function (e) {
        (e.merchantSPBGetWindowPath = "merchantSPB:merchantSPBGetWindowPath"),
          ...
          (e.merchantSPBGetFacilitatorAccessToken =
            "merchantSPB:merchantSPBGetFacilitatorAccessToken");
      })(e || (e = {}));
      const i = (function (e) {
        const t = {};
        return (
      ...
      function c() {
        return s(this, void 0, void 0, function* () {
          ...
          window.top
            ? (a.bindResponders({
                [i.merchantSPBGetWindowPath]: ({ path: e }) => o()(window, e),
                [i.merchantSPBCreateOrder]: () =>
                ...
                [i.merchantSPBErrorOrder]: (t) =>
                  e.onError(t.error || "unknown error"),
                [i.merchantSPBGuestEnabled]: ({ merchantId: e }) =>
                  s(this, void 0, void 0, function* () {
                    return yield window.exports.isGuestEnabled(e);
                  }),
                [i.merchantSPBGetFacilitatorAccessToken]: () =>
                  s(this, void 0, void 0, function* () {
